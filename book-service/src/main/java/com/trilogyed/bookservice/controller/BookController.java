...
public class BookController {
    ...
    @Autowired
    private final noteRetrieval noteRetrieval;

    BookController (noteRetrieval noteRetrieval) {
        this.noteRetrieval = noteRetrieval;
    }
    ...
    public Map<String, Integer> retrieveNotesById(@PathVariable int id) {
        ...
        return noteRetrieval.retrieveNotesById(id);
    }
